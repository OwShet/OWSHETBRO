...
client.login("NzU2ODExMzEzNzE5ODAzOTQ0.X2XRdg.vOx5J8NNxy7JMsPgBzVU0K0kVLI");
...
client.on("ready", () => {
  client.user.setActivity(`AŞİRET-İ PATRON`);
  console.log(`Logined`);
});
...
client.on("message", message => {
  ...
  if (spl[0] == "u!yardım") {
    let embed = new Discord.RichEmbed()
      .setColor("#070706")
      .addField(
        `Discord Uptime Bot Yardım Sistemi`,
        `Discord Botlarınız Benim Sayemde 7/24`
      )
      .setDescription(
        `**Komutlar**
...
`
      ...
      .setFooter(
        `Uptime Bot | Kodlayan Emir Bolat , Editleyen GamerWolf.`,
